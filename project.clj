(defproject htt-schedule "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "htt-schedule.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main htt-schedule.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "htt-schedule.core/on-figwheel-reload"}

                :compiler {:main htt-schedule.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/htt_schedule.js"
